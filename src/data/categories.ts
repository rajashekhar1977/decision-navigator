...
export const categories: CategoryConfig[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        showIf: (answers: any) => answers.intent === 'watch',
      },
      {
        id: 'gameType',
      ...
      },
      {
        ...
        showIf: (answers: any) => answers.intent === 'listen',
      },
      {
        id: 'bookGenre',
        text: 'What book genre?',
        type: 'multi',
        options: [
        ...
        showIf: (answers: any) => answers.intent === 'read',
      },
      {
        id: 'genre',
